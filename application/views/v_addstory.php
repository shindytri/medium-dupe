...
<html>
    ...
    <body>
        <div class="container">
            <form class="create-story" method="post" enctype="multipart/form-data" action="<?php echo site_url().'/Medium/tambahStory/'.$user[0]->id_user;?>">
                <div class="form-group borderless">
                    <input type="file" name="images" class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Photo"/>
                </div>
                <div class="form-group borderless">
